...
def shift_point_cloud(data: Array,
                      key: PRNGKeyArray,
                      shift_range: jnp.float32 = 0.1) -> Array:
...
batched_random_scale_point_cloud = vmap(random_scale_point_cloud,
